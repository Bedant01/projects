            ...
            <div class="form-register-with-email">
                ...
                <div class="form-white-background">
                    ...
                    <div class="form-row">
                        <label>
                            <span>Name</span>
                            <input type="text" name="txt_name" required placeholder="Enter Name">
                        </label>
                    </div>
                    ...
                    <div class="form-row">
                        <label>
                            <span>Number</span>
                            <input type="text" name="txt_phnumber" required id="season" placeholder="Enter number">
                        </label>
                    </div>                                       
                    ...
                    <div class="form-row">
                        <label>
                            <span>Season</span>
                            <input type="text" name="txt_season" required id="season" placeholder="Enter Season">
                        </label>
                    </div>
					<div class="form-row">
                        <label>
                            <span>Soil Type</span>
                            <input type="text" name="txt_soil" required id="soil" placeholder="Enter soil">
                        </label>
                    </div>
                    ...
                    <div class="form-row">
                        <label>
                            <span>Nitrogen</span>
                            <input type="number" name="txt_nitrogen" required id="nitrogen" placeholder="Enter Nitrogen amount in %">
                        </label>
                    </div>
                    ...
                    <div class="form-row">
                        <label>
                            ...
                            <input type="number" name="txt_phosphrous" required id="phosphrous" placeholder="Enter Phosphrous amount in % ">
                        </label>
                    </div>
                      ...
                      <div class="form-row">
                        <label>
                            ...
                            <input type="number" name="txt_Fer_hectare" required  placeholder="Enter Use Fertilizer For Hectare">
                        </label>
                    </div>
                        ...
                        <label>
                            ...
                            <input type="number" name="txt_ct_fert" required  placeholder="Enter Cost Of Fertilizer">
                        </label>
                    </div>
                   ...
                   <div class="form-row">
                        <label>
                            ...
                            <input type="number" name="txt_fer_year" required  placeholder="Enter Use Fertilizer For Year">
                        </label>
                    </div>
